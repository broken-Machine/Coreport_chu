!function (t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports.VueECharts = e() : t.VueECharts = e()
}(this, function () {
    return function (t) {
        function e(n) {
        ...
        function i(t) {
            ...
            } else if (P[n]) e = t.constructor.from(t); else if (!D[n] && !I(t)) {
                e = {};
        ...
        function f(t, e, i) {
            if (t && e)if (t.forEach && t.forEach === O) t.forEach(e, i); else if (t.length === +t.length)for (var n = 0, o = t.length; n < o; n++)e.call(i, t[n], n, t); else for (var r in t)t.hasOwnProperty(r) && e.call(i, t[r], r, t)
        }
        ...
        var C, D = {
            ...
            }, k = Object.prototype.toString, E = Array.prototype, O = E.forEach, z = E.filter, R = E.slice, V = E.map,
            N = E.reduce, B = {
                inherits: h,
                mixin: c,
                clone: i,
        ...
        (function (e) {
            ...
            function r(t, e, i) {
                ...
                var r = this._zr = E.init(t, {
                    renderer: i.renderer || "canvas",
                    devicePixelRatio: i.devicePixelRatio,
                    width: i.width,
                    height: i.height
                });
                this._throttledZrFlush = k.throttle(O.bind(r.flush, r), 17), this._theme = O.clone(e), this._chartsViews = [], this._chartsMap = {}, this._componentsViews = [], this._componentsMap = {}, this._api = new S(this), this._coordSysMgr = new M, R.call(this), this._messageCenter = new o, this._initEvents(), this.resize = O.bind(this.resize, this), this._pendingActions = [], V(it, n), V(tt, n), r.animation.on("frame", this._onframe, this)
            }
            ...
            function l(t, e) {
                var i = J[t.type], n = i.actionInfo, o = n.update || "update";
                this[j] = !0;
                var r = [t], a = !1;
                t.batch && (a = !0, r = O.map(t.batch, function (e) {
                    return e = O.defaults(O.extend({}, e), t), e.batch = null, e
                }));
                for (var s, l = [], u = "highlight" === t.type || "downplay" === t.type, h = 0; h < r.length; h++) {
                    var c = r[h];
                    s = i.action(c, this._model), s = s || O.extend({}, c), s.type = n.event || s.type, l.push(s), u && $[o].call(this, c)
                }
            ...
            function c(t, e) {
                ...
                e[i ? "eachComponent" : "eachSeries"](function (t, a) {
                    ...
                    if (!l) {
                        var u = T.parseClassType(a.type), h = i ? L.getClass(u.main, u.sub) : C.getClass(u.sub);
                        if (!h)return;
            ...
            function y(t, e) {
                ...
                __DEV__ && !b.canvasSupported && r && "source-over" !== r && console.warn("Only canvas support blendMode"), e.group.traverse(function (t) {
             ...
             */
            var b = i(14), w = i(339), S = i(134), M = i(16), I = i(340), T = i(11), A = i(13), L = i(68), C = i(22),
                D = i(2), P = i(5), k = i(48), E = i(127), O = i(0), z = i(20), R = i(27), V = i(73), N = O.each,
                B = 1e3, G = 5e3, F = 1e3, H = 2e3, W = 3e3, Z = 4e3, q = 5e3, j = "__flagInMainProcess",
                U = "__hasGradientOrPatternBg", X = "__optionUpdated";
            o.prototype.on = n("on"), o.prototype.off = n("off"), o.prototype.one = n("one"), O.mixin(o, R);
            var Y = r.prototype;
            Y._onframe = function () {
                ...
                if (__DEV__ && O.assert(!this[j], "`setOption` should not be called during main process."), this[j] = !0, !this._model || e) {
                    var n = new I(this._api), o = this._theme, r = this._model = new w(null, null, o, n);
                ...
                if (b.canvasSupported) {
                    ...
                    if (at[e]) {
                        ...
                        O.each(rt, function (o, h) {
                            if (o.group === e) {
                                var c = o.getRenderedCanvas(O.clone(t)), d = o.getDom().getBoundingClientRect();
                        ...
                        var c = s - r, d = l - a, f = O.createCanvas();
            ...
            }, Y.convertToPixel = O.curry(a, "convertToPixel"), Y.convertFromPixel = O.curry(a, "convertFromPixel"), Y.containPixel = function (t, e) {
                var i, n = this._model;
                return t = P.parseFinder(n, t), O.each(t, function (t, n) {
                    n.indexOf("Models") >= 0 && O.each(t, function (t) {
                        ...
                        if (o && o.containPoint) i |= !!o.containPoint(e); else if ("seriesModels" === n) {
                            ...
                            r && r.containPoint ? i |= r.containPoint(e, t) : __DEV__ && console.warn(n + ": " + (r ? "The found component do not support containPoint." : "No view mapping to the found component."))
                ...
                update: function (t) {
                    ...
                    if (e) {
                        ...
                        if (a.isSingleCanvas && a.isSingleCanvas()) o.configLayer(0, {clearColor: r}); else {
                            if (!b.canvasSupported) {
                                var s = z.parse(r);
                                r = z.stringify(s, "rgb"), 0 === s[3] && (r = "transparent")
                            }
            ...
            Y.resize = function (t) {
                __DEV__ && O.assert(!this[j], "`resize` should not be called during main process."), this[j] = !0, this._zr.resize(t);
                ...
                if (O.isObject(t) && (e = t, t = ""), t = t || "default", this.hideLoading(), !ot[t])return void(__DEV__ && console.warn("Loading effects " + t + " not exists."));
                ...
                var e = O.extend({}, t);
                return e.type = K[t.type], e
            }, Y.dispatchAction = function (t, e) {
                if (O.isObject(e) || (e = {silent: !!e}), J[t.type]) {
            ...
            Y._initEvents = function () {
                N(Q, function (t) {
                    this._zr.on(t, function (e) {
                        ...
                        } else o && o.eventData && (i = O.extend({}, o.eventData));
                        i && (i.event = e, i.type = t, this.trigger(t, i))
                    }, this)
                }, this), N(K, function (t, e) {
            ...
            var J = [], K = {}, tt = [], et = [], it = [], nt = {}, ot = {}, rt = {}, at = {}, st = new Date - 0,
                lt = new Date - 0, ut = "_echarts_instance_", ht = {version: "3.3.2", dependencies: {zrender: "3.2.2"}};
            ht.init = function (t, e, i) {
                if (__DEV__) {
                    if (E.version.replace(".", "") - 0 < ht.dependencies.zrender.replace(".", "") - 0)throw new Error("ZRender " + E.version + " is too old for ECharts " + ht.version + ". Current version need ZRender " + ht.dependencies.zrender + "+");
                ...
                O.isDom(t) ? t = ht.getInstanceByDom(t) : "string" == typeof t && (t = rt[t]), t instanceof r && !t.isDisposed() && t.dispose()
                ...
                if ("function" == typeof t && (e = t, t = B), __DEV__ && isNaN(t))throw new Error("Unkown processor priority");
                tt.push({prio: t, func: e})
            }, ht.registerAction = function (t, e, i) {
                "function" == typeof e && (i = e, e = "");
                var n = O.isObject(t) ? t.type : [t, t = {event: e}][0];
                ...
                if ("function" == typeof t && (e = t, t = F), __DEV__ && isNaN(t))throw new Error("Unkown layout priority");
                it.push({prio: t, func: e, isLayout: !0})
            }, ht.registerVisual = function (t, e) {
                if ("function" == typeof t && (e = t, t = W), __DEV__ && isNaN(t))throw new Error("Unkown visual priority");
                it.push({prio: t, func: e})
            }, ht.registerLoading = function (t, e) {
                ot[t] = e
            };
            var ct = T.parseClassType;
            ht.extendComponentModel = function (t, e) {
                ...
                O.createCanvas = t
            }, ht.registerVisual(H, i(355)), ht.registerPreprocessor(i(347)), ht.registerLoading("default", i(338)), ht.registerAction({
                type: "highlight",
                event: "highlight",
                update: "highlight"
            }, O.noop), ht.registerAction({
                type: "downplay",
                event: "downplay",
                update: "downplay"
            }, O.noop), ht.List = i(9), ht.Model = i(10), ht.graphic = i(2), ht.number = i(3), ht.format = i(8), ht.matrix = i(19), ht.vector = i(4), ht.color = i(20), ht.util = {}, N(["map", "each", "filter", "indexOf", "inherits", "reduce", "filter", "bind", "curry", "isArray", "isString", "isObject", "isFunction", "extend", "defaults", "clone"], function (t) {
                ht.util[t] = O[t]
            }), ht.PRIORITY = {
        ...
        var m = i(0), v = i(390), y = Math.round, x = i(12), _ = i(20), b = i(19), w = i(4), S = {};
        S.Group = i(51), S.Image = i(74), S.Text = i(122), S.Circle = i(381), S.Sector = i(387), S.Ring = i(386), S.Polygon = i(383), S.Polyline = i(384), S.Rect = i(385), S.Line = i(382), S.BezierCurve = i(380), S.Arc = i(379), S.CompoundPath = i(374), S.LinearGradient = i(119), S.RadialGradient = i(375), S.BoundingRect = i(7), S.extendShape = function (t) {
            return x.extend(t)
        ...
        var o = i(8), r = i(3), a = i(10), s = i(0), l = s.each, u = s.isObject, h = {};
        ...
        var o = i(0), r = i(7), a = i(3), s = i(8), l = a.parsePercent, u = o.each, h = {},
        ...
        var o = i(4), r = i(19), a = o.applyTransform, s = Math.min, l = Math.max;
        n.prototype = {
        ...
        (function (e) {
            ...
            var r = "undefined", a = "undefined" == typeof window ? e : window,
                ...
                u = {"float": s, "int": l, ordinal: Array, number: Array, time: Array}, h = i(10), c = i(45), d = i(0),
                f = i(5), p = d.isObject, g = ["stackedOn", "hasItemOption", "_nameList", "_idList", "_rawData"],
                m = function (t, e) {
            ...
            y.type = "list", y.hasItemOption = !0, y.getDimension = function (t) {
                ...
                if (t = t || [], __DEV__ && !d.isArray(t))throw new Error("Invalid data.");
                this._rawData = t;
                var n = this._storage = {}, o = this.indices = [], r = this.dimensions, a = t.length,
                    s = this._dimensionInfos, l = [], h = {};
                e = e || [];
                for (var c = 0; c < r.length; c++) {
                    var p = s[r[c]], g = u[p.type];
                    n[r[c]] = new g(a)
                }
                var m = this;
                i || (m.hasItemOption = !1), i = i || function (t, e, i, n) {
                        var o = f.getDataItemValue(t);
                        return f.isDataItemOption(t) && (m.hasItemOption = !0), f.converDataValue(o instanceof Array ? o[n] : o, s[e])
                    };
                for (var v = 0; v < t.length; v++) {
                    for (var y = t[v], x = 0; x < r.length; x++) {
                        var _ = r[x], b = n[_];
                        b[v] = i(y, _, v, x)
                    }
                    o.push(v)
                ...
                for (var c = 0; c < t.length; c++) {
                    ...
                    var w = e[c] || "", S = t[c] && t[c].id;
                    !S && w && (h[w] = h[w] || 0, S = w, h[w] > 0 && (S += "__ec__" + h[w]), h[w]++), S && (l[c] = S)
                }
                ...
                if (r)return r;
                if (i) {
                    for (var a = 1 / 0, s = -(1 / 0), l = 0, u = this.count(); l < u; l++)o = this.get(t, l, e),
                    o < a && (a = o), o > s && (s = o);
        ...
        var a = o.mixin;
        a(n, i(345)), a(n, i(342)), a(n, i(346)), a(n, i(344)), t.exports = n
    }, function (t, e, i) {
        function n(t) {
            var e = [];
        ...
        var o = i(10), r = i(0), a = Array.prototype.push, s = i(67), l = i(30), u = i(6), h = o.extend({
            type: "component",
            id: "",
            name: "",
            mainType: "",
        ...
        l.enableClassManagement(h, {registerWhenExtend: !0}), s.enableSubTypeDefaulter(h), s.enableTopologicalTravel(h, n), r.mixin(h, i(343)), t.exports = h
    }, function (t, e, i) {
        function n(t) {
            o.call(this, t), this.path = new a
        }

        var o = i(52), r = i(0), a = i(39), s = i(370), l = i(120), u = l.prototype.getCanvasPattern, h = Math.abs;
        n.prototype = {
            constructor: n,
            type: "path",
            __dirtyPath: !0,
        ...
        "use strict";
        var n = i(0), o = i(8), r = i(5), a = i(11), s = i(108), l = i(14), u = i(6), h = o.encodeHTML, c = o.addCommas,
            d = a.extend({
        ...
        var n = i(351), o = i(46);
        i(352), i(350);
        var r = i(47), a = i(3), s = i(0), l = i(23), u = {};
        ...
        var r = i(0), a = n.guessOrdinal = function (t, e) {
        ...
        "use strict";
        var n = i(2), o = i(7), r = n.extendShape({
            type: "triangle",
        ...
        var a = i(51), s = i(67), l = i(30), u = i(5), h = i(0);
        n.prototype = {
        ...
        var l = {}, u = 0, h = 5e3, c = i(0), d = i(7), f = c.retrieve, p = {
            getWidth: n,
            getBoundingRect: o,
        ...
        function h(t, e, i, n, o, a, s, l, u, h, c) {
            ...
            T[0] = u, T[1] = h;
            for (var _ = 0; _ < 1; _ += .05)A[0] = r(t, i, o, s, _),
                A[1] = r(e, n, a, l, _), g = x(T, A), g < y && (d = _, y = g);
            y = 1 / 0;
        ...
        var v = i(4), y = v.create, x = v.distSquare, _ = Math.pow, b = Math.sqrt, w = 1e-8, S = 1e-4, M = b(3),
            I = 1 / 3, T = y(), A = y(), L = y();
        t.exports = {
            cubicAt: r,
            cubicDerivativeAt: a,
        ...
        var o = i(3), r = o.linearMap, a = i(0), s = [0, 1], l = function (t, e, i) {
        ...
        var p = i(0), g = i(20), m = i(3).linearMap, v = p.each, y = p.isObject, x = -1, _ = function (t) {
        ...
        var u = i(9), h = i(17), c = i(0), d = i(5), f = i(16), p = d.getDataItemValue, g = d.converDataValue, m = {
            cartesian2d: function (t, e, i) {
                ...
                if (__DEV__) {
                    ...
                    if (!r)throw new Error('yAxis "' + c.retrieve(e.get("xAxisIndex"), e.get("yAxisId"), 0) + '" not found')
                }
                var l = o.get("type"), u = r.get("type"),
                ...
                var n = i.queryComponents({mainType: "polar", index: e.get("polarIndex"), id: e.get("polarId")})[0],
                    o = n.findAxisModel("angleAxis"), r = n.findAxisModel("radiusAxis");
                if (__DEV__) {
                    if (!o)throw new Error("angleAxis option not found");
                    if (!r)throw new Error("radiusAxis option not found")
                }
                var l = r.get("type"), u = o.get("type"),
        ...
        var r = i(0), a = {}, s = ".", l = "___EC__COMPONENT__CONTAINER___", u = a.parseClassType = function (t) {
            var e = {main: "", sub: ""};
            return t && (t = t.split(s), e.main = t[0] || "", e.sub = t[1] || ""), e
        };
        a.enableClassExtend = function (t, e) {
            t.$constructor = t, t.extend = function (t) {
                __DEV__ && r.each(e, function (e) {
                ...
                return r.extend(a.prototype, t), a.extend = this.extend, a.superCall = n, a.superApply = o, r.inherits(a, this), a.superClass = i, a
            }
            ...
            if (t.registerClass = function (t, e) {
                    ...
                    } else __DEV__ && n[e.main] && console.warn(e.main + " exists."), n[e.main] = t;
                    return t
        ...
        var u = i(27), h = i(14), c = "undefined" != typeof window && !!window.addEventListener, d = c ? function (t) {
        ...
        var r = i(2), a = i(56), s = n.prototype;
        ...
        var s = i(0), l = i(8), u = i(2), h = i(10), c = i(3), d = c.remRadian, f = c.isRadianAroundZero, p = i(4),
                    ...
                    if (s.each(p, function (t, o) {
                            if (!_(l, o, e.labelInterval)) {
                                ...
                                var a = r.getTextColor() || i.get("axisLine.lineStyle.color"), s = l.dataToCoord(t),
                                    c = [s, e.labelOffset + e.labelDirection * f], p = l.scale.getLabel(t),
                                    m = new u.Text({
                                        anid: "label_" + t,
                                        style: {
                                            text: g[o],
        ...
        var r = i(0), a = i(14), s = i(1), l = i(5), u = i(86), h = i(245), c = r.each, d = u.eachAxisDim,
                ...
                _autoSetAxisIndex: function () {
                    ...
                    t && d(function (e) {
                        ...
                        this._isSeriesHasAllAxesTypeOf(t, "value") && d(function (e) {
                            ...
                            if (__DEV__ && !s)throw new Error(e.axis + ' "' + r.retrieve(o, a, 0) + '" not found');
        ...
        "use strict";
        var n = i(24), o = i(4), r = i(71), a = i(7), s = i(50).devicePixelRatio,
        ...
        _.prototype = {
            constructor: _, _lineDash: null, _dashOffset: 0, _dashIdx: 0, _dashSum: 0, setScale: function (t, e) {
                ...
                for (; b < w && (S += p[b], !(S > f)); b++);
                for (s = (S - f) / _; s <= 1;)h = x(m, t, i, r, s), c = x(y, e, o, a, s),
                    b % 2 ? g.moveTo(h, c) : g.lineTo(h, c), s += p[b] / _, b = (b + 1) % w;
        ...
        var o = i(9), r = i(17), a = i(183), s = i(0), l = {
        ...
        "use strict";
        var n = i(2), o = i(0), r = i(1);
        i(104), i(230), r.extendComponentView({
        ...
        var h = i(27), c = i(0), d = i(31), f = i(90);
        c.mixin(u, h), t.exports = u
    }, function (t, e, i) {
        var n = i(101), o = i(0), r = i(11), a = i(6), s = ["value", "category", "time", "log"];
        ...
        function n(t, e) {
            ...
            o && r && (o = [l.parsePercent(o[0], s), l.parsePercent(o[1], u)], r = l.parsePercent(r, Math.min(s, u)), isNaN(o[0]) || isNaN(o[1]) || isNaN(r) ? __DEV__ && console.warn("Given layoutCenter or layoutSize data are invalid. Use left/top/width/height instead.") : d = !0);
            var f;
            if (d) {
                var f = {};
        ...
        var r = i(312), a = i(6), s = i(0), l = i(3), u = {};
        if (__DEV__)var h = function (t) {
        ...
        var c = {
            dimensions: r.prototype.dimensions, create: function (t, e) {
                ...
                t.eachComponent("geo", function (t, a) {
                    ...
                    __DEV__ && (l || h(s));
                    var c = new r(s + a, s, l && l.geoJson, l && l.specialAreas, t.get("nameMap"));
                ...
                return t.eachSeriesByType("map", function (t) {
                    ...
                    var l = u[a];
                    __DEV__ && (l || h(t[0].get("map")));
                    var c = s.map(t, function (t) {
                        return t.get("nameMap")
                    }), d = new r(a, a, l && l.geoJson, l && l.specialAreas, s.mergeAll(c));
                ...
                var i = (t || []).slice(), n = c.getMap(e), o = n && n.geoJson;
                if (!o)return __DEV__ && h(e), t;
        ...
        d.registerMap = c.registerMap, d.getMap = c.getMap, d.loadMap = function () {
        }, d.registerCoordinateSystem("geo", c), t.exports = c
    }, function (t, e) {
        "use strict";
        function i(t) {
            return t
        ...
        var n = i(3), o = i(8), r = i(47), a = Math.floor, s = Math.ceil, l = n.getPrecisionSafe, u = n.round,
            h = r.extend({
        ...
        var n = i(0), o = i(110), r = i(7), a = function (t) {
            t = t || {}, o.call(this, t);
        ...
        var o = i(0), r = i(121), a = i(110), s = i(124);
        n.prototype = {
            constructor: n,
            type: "displayable",
            __dirty: !0,
        ...
        var u = i(18), h = i(4), c = i(182), d = i(2), f = i(0), p = i(3), g = ["fromSymbol", "toSymbol"],
            m = l.prototype;
        ...
        var a = i(2), s = i(54), l = r.prototype;
        ...
        var a = i(0), s = i(18), l = i(2), u = i(3), h = o.prototype;
        ...
        h._updateCommon = function (t, e, i, o) {
            ...
            null != I && x.getShallow("show") ? (l.setText(S, x, h), S.text = a.retrieve(s.getFormattedLabel(e, "normal"), t.get(I, e))) : S.text = "", null != I && _.getShallow("show") ? (l.setText(m, _, h), m.text = a.retrieve(s.getFormattedLabel(e, "emphasis"), t.get(I, e))) : m.text = "";
        ...
        function n(t) {
            __DEV__ && N.assert(t), V.call(this), this._zr = t, this.group = new G.Group, this._brushType, this._brushOption, this._panels, this._track = [], this._dragging, this._covers = [], this._creatingCover, this._creatingPanel, this._enableGlobalPan, __DEV__ && this._mounted, this._uid = "brushController_" + it++, this._handlers = {}, Z(nt, function (t, e) {
        ...
        function o(t, e) {
            var i = t._zr;
            t._enableGlobalPan || F.take(i, J, t._uid), Z(t._handlers, function (t, e) {
                i.on(e, t)
        ...
        function r(t) {
            var e = t._zr;
            F.release(e, J, t._uid), Z(t._handlers, function (t, i) {
                e.off(i, t)
        ...
        var V = i(27), N = i(0), B = i(7), G = i(2), F = i(90), H = i(45), W = N.curry, Z = N.each, q = N.map,
            j = Math.min, U = Math.max, X = Math.pow, Y = 1e4, $ = 6, Q = 6, J = "globalPan",
        ...
        n.prototype = {
            constructor: n, enableBrush: function (t) {
                return __DEV__ && N.assert(this._mounted),
                this._brushType && r(this), t.brushType && o(this, t), this
                ...
                return this.enableBrush(!1), p(this), this._zr.remove(this.group), __DEV__ && (this._mounted = !1), this
            }, dispose: function () {
        ...
        var nt = {
            mousedown: function (t) {
                if (this._dragging) z.call(this, t); else if (!t.target || !t.target.draggable) {
                    k(t);
                    var e = t.offsetX, i = t.offsetY;
        ...
        function r(t, e, i, o) {
            ...
            return __DEV__ && a.assert(r, "line brush is only available in cartesian (grid)."), n(a.map([0, 1], function (t) {
                return e ? r.coordToData(r.toLocalCoord(o[t])) : r.toGlobalCoord(r.dataToCoord(o[t]))
            }))
        }

        var a = i(0), s = i(2), l = a.each, u = {}, h = ["geo", "xAxis", "yAxis"], c = "--",
        ...
        u.parseOutputRanges = function (t, e, i, n) {
            ...
            l(t.areas, function (e) {
                ...
                __DEV__ && (a.assert(!i || i === !0 || e.coordRange, "coordRange must be specified when coord index specified."), a.assert(!i || i !== !0 || e.range, "range must be specified.")), e.range = e.range || [], i && i !== !0 && (e.range = f[e.brushType](0, i, e.coordRange), e.panelId = i.panelId)
            })
                ...
                null != o && "none" !== o && ("all" === o || a.isArray(o) || (o = [o]), e.eachComponent({mainType: n}, function (t, e) {
                    if (!("all" !== o && a.indexOf(o, e) < 0)) {
                        ...
                        for (var l, u = 0, h = i.length; u < h; u++) {
                            var d = i[u];
                            if (__DEV__ && a.assert(d[n + "Index"] != e, "Coord should not be defined duplicately: " + n + e), "yAxis" === n && !d.yAxis && d.xAxis) {
        ...
        var o = i(5), r = i(0), a = i(14), s = i(8), l = s.addCommas, u = s.encodeHTML, h = i(1).extendComponentModel({
            type: "marker",
            dependencies: ["series", "grid", "polar", "geo"],
            init: function (t, e, i, n) {
                if (__DEV__ && "marker" === this.type)throw new Error("Marker component is abstract component. Use markLine, markPoint, markArea instead.");
        ...
        t.exports = i(1).extendComponentView({
        ...
        var s = i(0), l = i(3), u = s.indexOf, h = s.curry,
        ...
        function r(t, e) {
            if (t.type = e.get("type"), t.scale = u.createScaleByModel(e), t.onBand = e.get("boundaryGap") && "category" === t.type, "angleAxis" === e.mainType) {
        ...
        var a = i(325), s = i(3), l = i(0), u = i(15), h = u.niceScaleExtent;
        i(326);
        var c = {
            dimensions: a.prototype.dimensions, create: function (t, e) {
                ...
                return t.eachComponent("polar", function (t, s) {
                    ...
                    if ("polar" === e.get("coordinateSystem")) {
                        ...
                        if (__DEV__ && !i)throw new Error('Polar "' + l.retrieve(e.get("polarIndex"), e.get("polarId"), 0) + '" not found');
                        e.coordinateSystem = i.coordinateSystem
                    }
                }), i
            }
        };
        i(16).register("polar", c)
    }, function (t, e) {
        ...
        var n = i(0), o = i(30), r = o.parseClassType, a = 0, s = {}, l = "_";
        s.getUID = function (t) {
        ...
        var n = i(51), o = i(67), r = i(30), a = function () {
        ...
        var n = i(4), o = i(24), r = {}, a = Math.min, s = Math.max, l = Math.sin, u = Math.cos, h = n.create(),
        ...
        var o = i(52), r = i(7), a = i(0), s = i(372), l = new s(50);
        n.prototype = {
        ...
        var o = i(2), r = i(54), a = i(0), s = i(18), l = i(4), u = i(24), h = n.prototype;
        ...
        var n = i(9), o = i(335), r = i(107), a = i(17), s = i(16), l = i(0), u = i(28);
        ...
        var n = i(8), o = i(0), r = {}, a = ["x", "y", "z", "radius", "angle"];
        ...
        var o = i(0), r = o.each, a = "\0_ec_hist_store", s = {
            push: function (t, e) {
                var i = n(t);
                r(e, function (e, n) {
        ...
        a.prototype = {
            constructor: a, draw: function (t, e, i, a, s) {
                ...
                u.each(c.regions, function (e) {
                    ...
                    var I = _.get("show"), T = b.get("show"), A = h && isNaN(h.get("value", r)),
                        L = h && h.getItemLayout(r);
                    if (!h || A && (I || T) || L && L.showLabel) {
                        var C = h ? r : e.name, D = t.getFormattedLabel(C, "normal"),
                            P = t.getFormattedLabel(C, "emphasis"), k = new l.Text({
                                ...
                                hoverStyle: {text: T ? P || e.name : "", fill: M.getTextColor(), textFont: M.getFont()},
        ...
        i(1).registerAction({type: "takeGlobalCursor", event: "globalCursorTaken", update: "update"}, function () {
        }), t.exports = r
    }, function (t, e, i) {
        function n(t, e, i) {
        ...
        }), n.registerPreprocessor(i(322))
    }, function (t, e, i) {
        var n = i(1), o = i(0), r = i(14), a = i(109), s = i(26), l = i(49), u = s.mapVisual, h = i(5),
            c = s.eachVisual, d = i(3), f = o.isArray, p = o.each, g = d.asc, m = d.linearMap, v = o.noop,
        ...
        var n = i(0), o = i(2), r = i(8), a = i(6), s = i(1), l = i(26);
        ...
        var n = i(1), o = {type: "selectDataRange", event: "dataRangeSelected", update: "update"};
        ...
        var a = i(4), s = i(19), l = i(125), u = i(0), h = i(7), c = a.applyTransform;
        ...
        var o = i(11), r = i(0), a = i(43), s = o.extend({
        ...
        r.merge(s.prototype, i(36)), r.merge(s.prototype, i(102));
        var l = {offset: 0};
        ...
        function s(t, e) {
            return c.map(y, function (e) {
                ...
                if (__DEV__ && !i)throw new Error(e + ' "' + c.retrieve(t.get(e + "Index"), t.get(e + "Id"), 0) + '" not found');
                return i
            })
        }
        ...
        var u = i(6), h = i(15), c = i(0), d = i(309), f = i(307), p = c.each, g = h.ifAxisCrossZero,
            m = h.niceScaleExtent;
        i(310);
        var v = r.prototype;
        ...
        r.create = function (t, e) {
            ...
            return t.eachComponent("grid", function (n, o) {
                ...
                if (l(e)) {
                    var i = s(e, t), n = i[0], o = i[1], r = n.findGridModel();
                    if (__DEV__) {
                        if (!r)throw new Error('Grid "' + c.retrieve(n.get("gridIndex"), n.get("gridId"), 0) + '" not found');
                        if (n.findGridModel() !== o.findGridModel())throw new Error("xAxis and yAxis must use the same grid")
                    }
                    var a = r.coordinateSystem;
                    e.coordinateSystem = a.getCartesian(n.componentIndex, o.componentIndex)
                }
            }), i
        }, r.dimensions = d.prototype.dimensions, i(16).register("cartesian2d", r), t.exports = r
    }, function (t, e, i) {
        function n(t, e, i) {
        ...
        var o = i(114), r = i(7), a = i(71), s = i(4);
        n.prototype = {
        ...
        var o = i(319);
        i(16).register("parallel", {create: n})
    }, function (t, e, i) {
        function n(t) {
        ...
        var c = i(0), d = c.each, f = "\0__link_datas", p = "\0__link_mainData";
        t.exports = n
    }, function (t, e) {
        t.exports = {
        ...
        "use strict";
        var n = i(118), o = i(27), r = i(125), a = i(388), s = i(0), l = function (t) {
        ...
        function p(t, e, i, n, o) {
            ...
            if (x) {
                ...
                if (!C) {
                    for (var E = A[x - 1], D = 0; D < x - 1; D++)w ? l(A[D], E, I) : !isNaN(A[D]) || isNaN(E) || M || S || (A[D] = E);
                    w && l(d(t._target, o), E, I);
                    var O, z, R, V, N, B, G = 0, F = 0;
                    if (S)var H = [0, 0, 0, 0];
                    var W = function (t, e) {
                        var i;
                        if (e < 0) i = 0; else if (e < F) {
                            for (O = Math.min(G + 1, x - 1), i = O; i >= 0 && !(T[i] <= e); i--);
                            i = Math.min(i, x - 2)
                        } else {
                            for (i = G; i < x && !(T[i] > e); i++);
                            i = Math.min(i - 1, x - 2)
                        ...
                        G = i, F = e;
                        var n = T[i + 1] - T[i];
                        if (0 !== n)if (z = (e - T[i]) / n, v)if (V = A[i], R = A[0 === i ? i : i - 1], N = A[i > x - 2 ? x - 1 : i + 1], B = A[i > x - 3 ? x - 1 : i + 2], w) h(R, V, N, B, z, z * z, z * z * z, d(t, o), I); else {
                            var l;
                            if (S) l = h(R, V, N, B, z, z * z, z * z * z, H, 1), l = f(H); else {
                                if (M)return a(V, N, z);
                                l = c(R, V, N, B, z, z * z, z * z * z)
                            }
                            p(t, o, l)
                        } else if (w) s(A[i], A[i + 1], z, d(t, o), I); else {
                            var l;
                            if (S) s(A[i], A[i + 1], z, H, 1), l = f(H); else {
                                if (M)return a(A[i], A[i + 1], z);
                                l = r(A[i], A[i + 1], z)
                            }
                            p(t, o, l)
                        }
        ...
        var g = i(366), m = i(20), v = i(0), y = v.isArrayLike, x = Array.prototype.slice, _ = function (t, e, i, r) {
        ...
        "use strict";
        var n = i(0), o = i(53), r = function (t, e, i, n, r, a) {
        ...
        r.prototype = {
            ...
            bind: function (t, e, i) {
                ...
                if ((a || n.fill !== r.fill) && (t.fillStyle = n.fill), (a || n.stroke !== r.stroke) && (t.strokeStyle = n.stroke), (a || n.opacity !== r.opacity) && (t.globalAlpha = null == n.opacity ? 1 : n.opacity), (a || n.blend !== r.blend) && (t.globalCompositeOperation = n.blend || "source-over"),
                        this.hasStroke()) {
                    var h = n.lineWidth;
        ...
        var n = i(52), o = i(0), r = i(23), a = function (t) {
            n.call(this, t)
        };
        a.prototype = {
        ...
        var o = i(23), r = i(7), a = new r, s = function () {
        };
        s.prototype = {
        ...
        var o = i(19), r = i(4), a = o.identity, s = 5e-5, l = function (t) {
         ...
         */
        var o = i(118), r = i(14), a = i(0), s = i(361), l = i(364), u = i(365), h = i(373), c = !r.canvasSupported,
            d = {canvas: i(363)}, f = {}, p = {};
        ...
        t.exports = i(1), i(184), i(135), i(204), i(219), i(209), i(193), i(222), i(161), i(157), i(153), i(200), i(214), i(139), i(144), i(150), i(189), i(174), i(256), i(41), i(257), i(296), i(272), i(254), i(92), i(276), i(237), i(286), i(244), i(300), i(264), i(263), i(262), i(277), i(287), i(394)
    }, function (t, e, i) {
        var n, o;
        i(360), n = i(130);
        var r = i(358);
        o = n = n || {}, "object" != typeof n["default"] && "function" != typeof n["default"] || (o = n = n["default"]), "function" == typeof o && (o = o.options), o.render = r.render, o.staticRenderFns = r.staticRenderFns, t.exports = n
    }, function (t, e, i) {
        "use strict";
        function n(t) {
        ...
        var o = i(1), r = n(o), a = i(356), s = n(a), l = i(131),
            u = ["legendselectchanged", "legendselected", "legendunselected", "datazoom", "datarangeselected", "timelinechanged", "timelineplaychanged", "restore", "dataviewchanged", "magictypechanged", "geoselectchanged", "geoselected", "geounselected", "pieselectchanged", "pieselected", "pieunselected", "mapselectchanged", "mapselected", "mapunselected", "axisareaselected", "brush", "brushselected"],
            h = ["click", "dblclick", "mouseover", "mouseout", "mousedown", "mouseup", "globalout"];
        e["default"] = {
            props: {
                options: Object,
                theme: String,
                ...
                options: {
                    handler: function (t) {
                        !this.chart && t ? this._init() : this.chart.setOption(this.options, !0)
                    }, deep: !0
                }, group: {
                    handler: function (t) {
                        this.chart.group = t
                ...
                mergeOptions: function (t) {
                    this._delegateMethod("setOption", t)
                }, resize: function (t) {
                    this._delegateMethod("resize", t)
                }, dispatchAction: function (t) {
                    this._delegateMethod("dispatchAction", t)
                }, convertToPixel: function (t, e) {
                    return this._delegateMethod("convertToPixel", t, e)
                }, convertFromPixel: function (t, e) {
                    return this._delegateMethod("convertFromPixel", t, e)
                }, containPixel: function (t, e) {
                    return this._delegateMethod("containPixel", t, e)
                }, showLoading: function (t, e) {
                    this._delegateMethod("showLoading", t, e)
                }, hideLoading: function () {
                    this._delegateMethod("hideLoading")
                }, getDataURL: function (t) {
                    return this._delegateMethod("getDataURL", t)
                }, getConnectedDataURL: function (t) {
                    return this._delegateMethod("getConnectedDataURL", t)
                }, clear: function () {
                    this._delegateMethod("clear")
                }, dispose: function () {
                    this._delegateMethod("dispose")
                }, _delegateMethod: function (t) {
                    var e;
                    if (!this.chart)return void(0, l.warn)("Cannot call [" + t + "] before the chart is initialized. Set prop [options] first.", this);
                    for (var i = arguments.length, n = Array(i > 1 ? i - 1 : 0), o = 1; o < i; o++)n[o - 1] = arguments[o];
                    return (e = this.chart)[t].apply(e, n)
                }, _init: function () {
                    var t = this;
                    if (!this.chart) {
                        var e = r["default"].init(this.$el, this.theme, this.initOptions);
                        this.group && (e.group = this.group), e.setOption(this.options, !0), u.forEach(function (i) {
                            e.on(i, function (e) {
                                t.$emit(i, e)
                            })
                        }), h.forEach(function (i) {
                            e.on(i, function (e) {
                                t.$emit(i, e), t.$emit("chart" + i, e)
                            })
                        }), this.autoResize && (this.__resizeHanlder = (0, s["default"])(function () {
                            e.resize()
                        }, 100, {leading: !0}), window.addEventListener("resize", this.__resizeHanlder)), this.chart = e
                    }
                }
            }, mounted: function () {
                this.options && this._init()
            }, beforeDestroy: function () {
                this.chart && (this.autoResize && window.removeEventListener("resize", this.__resizeHanlder), this.dispose())
            }, connect: function (t) {
                "string" != typeof t && (t = t.map(function (t) {
                    return t.chart
                })), r["default"].connect(t)
            }, disconnect: function (t) {
                r["default"].disconnect(t)
            }, registerMap: function () {
                r["default"].registerMap.apply(r["default"], arguments)
            }, registerTheme: function () {
                r["default"].registerTheme.apply(r["default"], arguments)
            }
        }, t.exports = e["default"]
    }, function (t, e, i) {
        "use strict";
        ...
        t.exports = n.extend({
            ...
            getInitialData: function (t, e) {
                if (__DEV__) {
                    ...
                    if ("cartesian2d" !== i)throw new Error("Bar only support cartesian2d coordinateSystem")
                }
        ...
        var o = i(0), r = i(2);
        o.extend(i(10).prototype, i(138)), t.exports = i(1).extendChartView({
        ...
        var n = i(37)([["fill", "color"], ["stroke", "borderColor"], ["lineWidth", "borderWidth"], ["stroke", "barBorderColor"], ["lineWidth", "barBorderWidth"], ["opacity"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["shadowColor"]]);
        t.exports = {
        ...
        var n = i(1);
        i(140), i(141), n.registerVisual(i(143)), n.registerLayout(i(142))
    }, function (t, e, i) {
        "use strict";
        var n = i(0), o = i(13), r = i(40), a = o.extend({
            type: "series.boxplot",
        ...
        var o = i(0), r = i(22), a = i(2), s = i(40), l = r.extend({
        ...
        var a = i(0), s = i(3), l = s.parsePercent, u = a.each;
        t.exports = function (t) {
            var e = n(t);
            u(e, function (t) {
        ...
        var n = i(1);
        i(145), i(146), n.registerPreprocessor(i(149)), n.registerVisual(i(148)), n.registerLayout(i(147))
    }, function (t, e, i) {
        "use strict";
        var n = i(0), o = i(13), r = i(40), a = i(8), s = a.encodeHTML, l = a.addCommas, u = o.extend({
        ...
        var n = i(0), o = i(1);
        i(151), i(152), o.registerVisual(n.curry(i(38), "effectScatter", "circle", null)), o.registerLayout(n.curry(i(65), "effectScatter"))
    }, function (t, e, i) {
        "use strict";
        var n = i(28), o = i(13);
        t.exports = o.extend({
        ...
        var n = i(0), o = i(1);
        i(154), i(155), o.registerVisual(n.curry(i(69), "funnel")), o.registerLayout(i(156)), o.registerProcessor(n.curry(i(66), "funnel"))
    }, function (t, e, i) {
        "use strict";
        var n = i(9), o = i(5), r = i(17), a = i(1).extendSeriesModel({
            type: "series.funnel",
            init: function (t) {
        ...
        var r = i(2), a = i(0), s = n.prototype, l = ["itemStyle", "normal", "opacity"];
        ...
        var a = i(6), s = i(3), l = s.parsePercent;
        ...
        var n = i(9), o = i(13), r = i(0), a = o.extend({
            type: "series.gauge",
            getInitialData: function (t, e) {
        ...
        var r = i(160), a = i(2), s = i(3), l = s.parsePercent, u = 2 * Math.PI, h = i(22).extend({
            type: "gauge", render: function (t, e, i) {
                ...
                for (var d = this.group, f = r.cx, p = r.cy, g = r.r, m = t.get("min"), v = t.get("max"), y = t.getModel("splitLine"), x = t.getModel("axisTick"), _ = t.getModel("axisLabel"), b = t.get("splitNumber"), w = x.get("splitNumber"), S = l(y.get("length"), g), M = l(x.get("length"), g), I = u, T = (h - u) / b, A = T / w, L = y.getModel("lineStyle").getLineStyle(), C = x.getModel("lineStyle").getLineStyle(), D = _.getModel("textStyle"), P = 0; P <= b; P++) {
                    ...
                    if (_.get("show")) {
                        var z = o(s.round(P / b * (v - m) + m), _.get("formatter")), R = _.get("distance"),
                            V = new a.Text({
                                style: {
                                    text: z,
                                    x: k * (g - S - R) + f,
                    ...
                    if (x.get("show") && P !== b) {
                        for (var N = 0; N <= w; N++) {
                            var k = Math.cos(I), E = Math.sin(I), B = new a.Line({
                                shape: {
                                    x1: k * g + f,
                                    y1: E * g + p,
                                    x2: k * (g - M) + f,
                            ...
                            "auto" === C.stroke && B.setStyle({stroke: n((P + N / w) / b)}), d.add(B), I += A
                        }
                        I -= A
                    } else I += T
                }
        ...
        var n = i(1), o = i(0);
        i(162), i(163), i(172), n.registerProcessor(i(165)), n.registerVisual(o.curry(i(38), "graph", "circle", null)), n.registerVisual(i(166)), n.registerVisual(i(169)), n.registerLayout(i(173)), n.registerLayout(i(167)), n.registerLayout(i(171)), n.registerCoordinateSystem("graphView", {create: i(168)})
    }, function (t, e, i) {
        "use strict";
        var n = i(9), o = i(0), r = i(5), a = i(10), s = i(83), l = i(1).extendSeriesModel({
            type: "series.graph",
            init: function (t) {
        ...
        var o = i(32), r = i(55), a = i(42), s = i(2), l = i(164), u = i(0), h = ["itemStyle", "normal", "opacity"],
        ...
        var o = i(24), r = i(4), a = [], s = [], l = [], u = o.quadraticAt, h = r.distSquare, c = Math.abs;
        t.exports = function (t, e) {
            function i(t) {
        ...
        var n = i(170), o = i(3), r = i(80), a = i(78), s = i(4), l = i(0);
        t.exports = function (t) {
            t.eachSeriesByType("graph", function (t) {
                var e = t.coordinateSystem;
        ...
        var n = i(1), o = i(77), r = {type: "graphRoam", event: "graphRoam", update: "none"};
        ...
        var a = i(2), s = i(175), l = i(0);
        t.exports = i(1).extendChartView({
            type: "heatmap", render: function (t, e, i) {
                ...
                var s = n.getBandWidth(), u = o.getBandWidth(), h = e.getData(), c = "itemStyle.normal",
                    d = "itemStyle.emphasis", f = "label.normal", p = "label.emphasis",
                    g = e.getModel(c).getItemStyle(["color"]), m = e.getModel(d).getItemStyle(),
        ...
        var o = i(82), r = i(0), a = i(81), s = i(4), l = n.prototype;
        ...
        var a = i(0), s = i(18), l = i(2), u = i(3), h = i(56), c = l.Group, d = 3, f = r.prototype;
        ...
        var o = i(2), r = i(115), a = i(113), s = o.extendShape({
        ...
        var o = i(2), r = i(18), a = o.extendShape({
        ...
        var o = i(2), r = i(4), a = o.Line.prototype, s = o.BezierCurve.prototype;
        ...
        var s = i(0), l = i(2), u = i(12), h = u.extend({
        ...
        var n = i(0), o = i(1), r = o.PRIORITY;
        i(185), i(186), o.registerVisual(n.curry(i(38), "line", "circle", "line")), o.registerLayout(n.curry(i(65), "line")), o.registerProcessor(r.PROCESSOR.STATISTIC, n.curry(i(349), "line")), i(41)
    }, function (t, e, i) {
        "use strict";
        var n = i(28), o = i(13);
        t.exports = o.extend({
            ...
            getInitialData: function (t, e) {
                if (__DEV__) {
                    var i = t.coordinateSystem;
                    if ("polar" !== i && "cartesian2d" !== i)throw new Error("Line not support coordinateSystem besides cartesian and polar")
                }
        ...
        function d(t, e) {
            ...
            if (i && i.length && t.count()) {
                ...
                if (!n || "cartesian2d" !== e.type)return void(__DEV__ && console.warn("Visual map on line style only support x or y dimension."));
        ...
        var f = i(0), p = i(32), g = i(56), m = i(187), v = i(2), y = i(5), x = i(188), _ = i(22);
        t.exports = _.extend({
        ...
        var a = i(12), s = i(4), l = s.min, u = s.max, h = s.scaleAndAdd, c = s.copy, d = [], f = [], p = [];
        t.exports = {
            Polyline: a.extend({
                type: "ec-polyline",
        ...
        i(190), i(191);
        var n = i(1);
        n.registerLayout(i(192))
    }, function (t, e, i) {
        "use strict";
        function n(t) {
            var e = t.data;
            e && e[0] && e[0][0] && e[0][0].coord && (__DEV__ && console.warn("Lines data configuration has been changed to { coords:[[1,2],[2,3]] }"), t.data = a.map(e, function (t) {
                var e = [t[0].coord, t[1].coord], i = {coords: e};
                return t[0].name && (i.fromName = t[0].name), t[1].name && (i.toName = t[1].name), a.mergeAll([i, t[0], t[1]])
            }))
        }

        var o = i(13), r = i(9), a = i(0), s = i(16), l = o.extend({
            type: "series.lines",
            dependencies: ["grid", "polar"],
            ...
            getInitialData: function (t, e) {
                if (__DEV__) {
                    ...
                    if (!i)throw new Error("Unkown coordinate system " + t.coordinateSystem)
                }
                var n = new r(["value"], this);
                return n.hasItemOption = !1, n.initData(t.data, [], function (t, e, i, o) {
        ...
        var n = i(55), o = i(81), r = i(54), a = i(82), s = i(178), l = i(180);
        i(1).extendChartView({
            type: "lines", init: function () {
                ...
                __DEV__ && c && f && console.warn("Large lines not support effect"), c === this._hasEffet && d === this._isPolyline && f === this._isLarge || (h && h.remove(), h = this._lineDraw = f ? new l : new n(d ? c ? s : a : c ? o : r), this._hasEffet = c, this._isPolyline = d, this._isLarge = f);
        ...
        t.exports = function (t) {
            t.eachSeriesByType("lines", function (t) {
                ...
                i.each(function (n) {
                    var o = i.getItemModel(n), r = o.option instanceof Array ? o.option : o.get("coords");
                    if (__DEV__ && !(r instanceof Array && r.length > 0 && r[0] instanceof Array))throw new Error("Invalid coords " + JSON.stringify(r) + ". Lines must have 2d coords array in data item.");
                    var a = [];
        ...
        var n = i(1), o = n.PRIORITY;
        i(194), i(195), i(76), i(44), n.registerLayout(i(198)), n.registerVisual(i(199)), n.registerProcessor(o.PROCESSOR.STATISTIC, i(197)), n.registerPreprocessor(i(196)), i(75)("map", [{
        ...
        var n = i(9), o = i(13), r = i(0), a = i(17), s = i(8), l = s.encodeHTML, u = s.addCommas, h = i(59), c = i(44),
            d = o.extend({
                type: "series.map",
                layoutMode: "box",
                needsDrawMap: !1,
        ...
        var n = i(1);
        i(92), i(201), i(202), n.registerVisual(i(203))
    }, function (t, e, i) {
        function n(t, e, i) {
        ...
        var l = i(2), u = i(0), h = .3, c = i(22).extend({
        ...
        i(205), i(206), i(75)("pie", [{
            ...
            event: "pieunselected",
            method: "unSelect"
        }]), o.registerVisual(n.curry(i(69), "pie")), o.registerLayout(n.curry(i(208), "pie")), o.registerProcessor(n.curry(i(66), "pie"))
    }, function (t, e, i) {
        "use strict";
        var n = i(9), o = i(0), r = i(5), a = i(17), s = i(59), l = i(1).extendSeriesModel({
            type: "series.pie",
            init: function (t) {
                l.superApply(this, "init", arguments), this.legendDataProvider = function () {
                    return this._dataBeforeProcessed
        ...
        t.exports = function (t, e, i, n) {
            ...
            l.each(function (i) {
                ...
                var D = g.getModel("textStyle").getFont(), P = g.get("rotate") ? b < 0 ? -_ + Math.PI : -_ : 0,
                    k = t.getFormattedLabel(i, "normal") || l.getName(i), E = r.getBoundingRect(k, D, d, "top");
                h = !!P, f.label = {
                    x: n,
                    y: o,
                    position: m,
        ...
        var n = i(3), o = n.parsePercent, r = i(207), a = i(0), s = 2 * Math.PI, l = Math.PI / 180;
        t.exports = function (t, e, i, u) {
            e.eachSeriesByType(t, function (t) {
                ...
                M[0] = 0;
                var I = s, T = 0, A = y, L = w ? 1 : -1;
                if (v.each("value", function (t, e) {
                        var i;
                        i = "area" !== S ? 0 === _ ? b : t * b : s / (v.count() || 1), i < x ? (i = x, I -= x) : T += t;
                        var o = A + L * i;
                        v.setItemLayout(e, {
                            angle: i,
                            startAngle: A,
                ...
                } else b = I / T, A = y, v.each("value", function (t, e) {
        ...
        var n = i(0), o = i(1);
        i(273), i(210), i(211), o.registerVisual(n.curry(i(69), "radar")), o.registerVisual(n.curry(i(38), "radar", "circle", null)), o.registerLayout(i(213)), o.registerProcessor(n.curry(i(66), "radar")), o.registerPreprocessor(i(212))
    }, function (t, e, i) {
        "use strict";
        var n = i(13), o = i(9), r = i(17), a = i(0), s = n.extend({
            type: "series.radar",
            dependencies: ["radar"],
            init: function (t) {
        ...
        var n = i(1);
        i(215),
            i(216), n.registerLayout(i(217)), n.registerVisual(i(218))
    }, function (t, e, i) {
        var n = i(13), o = i(83), r = n.extend({
            type: "series.sankey",
            layoutInfo: null,
            getInitialData: function (t) {
        ...
        var o = i(2), r = i(0), a = o.extendShape({
        ...
        var n = i(0), o = i(1);
        i(220), i(221), o.registerVisual(n.curry(i(38), "scatter", "circle", null)), o.registerLayout(n.curry(i(65), "scatter")), i(41)
    }, function (t, e, i) {
        "use strict";
        var n = i(28), o = i(13);
        t.exports = o.extend({
        ...
        var n = i(1);
        i(224), i(225), i(226), n.registerVisual(i(228)), n.registerLayout(i(227))
    }, function (t, e, i) {
        function n(t) {
        ...
        var a = i(2), s = i(6), l = i(0), u = i(29), h = 8, c = 8, d = 5;
        n.prototype = {
        ...
        var r = i(13), a = i(336), s = i(0), l = i(10), u = i(8), h = i(29), c = u.encodeHTML, d = u.addCommas;
        t.exports = r.extend({
            type: "series.treemap",
            layoutMode: "box",
            dependencies: ["grid", "polar"],
        ...
        function o(t, e, i, n, o, l, u, h, c, d) {
            function f(e) {
                z.dataIndex = u.dataIndex, z.seriesIndex = t.seriesIndex;
                var i = T.borderWidth, n = Math.max(A - 2 * i, 0), o = Math.max(L - 2 * i, 0);
                z.culling = !0, z.setShape({x: i, y: i, width: n, height: o});
                var r = u.getVisual("color", !0);
                p(z, function () {
                    var t = {fill: r}, e = u.getModel("itemStyle.emphasis").getItemStyle();
                    g(t, e, r, n, o), z.setStyle(t), s.setHoverStyle(z, e)
                }), e.add(z)
            }
            ...
            if (u) {
                ...
                if (T && T.isInView) {
                    ...
                    if (k) {
                        ...
                        var E = x("background", v, d, S);
                        E && (E.setShape({x: 0, y: 0, width: A, height: L}), p(E, function () {
                            E.setStyle("fill", u.getVisual("borderColor", !0))
                        }), k.add(E));
                        var O = u.viewChildren;
                        if (!O || !O.length) {
                            var z = x("content", v, d, M);
                            z && f(k)
                        }
                        return k
                    }
        ...
        var a = i(0), s = i(2), l = i(45), u = i(29), h = i(223), c = i(42), d = i(7), f = i(19), p = i(353),
        ...
        for (var n = i(1), o = i(29), r = function () {
        ...
        function n(t, e, i) {
            ...
            t.eachComponent(n, function (t) {
                var n = e.getWidth(), r = e.getHeight(), a = t.option, s = a.size || [], l = b(w(a.width, s[0]), n),
                    ...
                    I = v.getPathToRoot(M);
                if ("treemapMove" !== g) {
                    var T = "treemapZoomToNode" === g ? c(t, x, M, l, u) : _ ? [_.width, _.height] : [l, u], A = a.sort;
                ...
                D.setLayout(d(h, _, x), !0), t.setLayoutInfo(h), f(D, new y((-h.x), (-h.y), n, r), I, M, 0)
            })
        }
        ...
        var p = i(0), g = i(3), m = i(6), v = i(29), y = i(7), v = i(29), x = Math.max, _ = Math.min,
        ...
        var c = i(26), d = i(20), f = i(0), p = f.isArray, g = "itemStyle.normal";
        t.exports = function (t, e, i) {
        ...
        var o = i(0), r = i(2), a = i(10), s = ["axisLine", "axisLabel", "axisTick", "splitLine", "splitArea"];
        ...
        var o = i(0), r = i(2), a = i(33), s = a.ifIgnoreOnTick, l = a.getInterval,
        ...
        var o = i(0), r = i(33), a = i(57), s = i(2), l = ["axisLine", "axisLabel", "axisTick", "axisName"],
            u = i(1).extendComponentView({
        ...
        var o = i(0), r = i(2), a = i(33), s = ["axisLine", "axisLabel", "axisTick", "axisName"],
        ...
        var o = i(33), r = i(0), a = i(2), s = o.getInterval, l = o.ifIgnoreOnTick,
            u = ["axisLine", "axisLabel", "axisTick", "axisName"], h = "splitLine", c = i(1).extendComponentView({
        ...
        var n = i(1), o = {type: "axisAreaSelect", event: "axisAreaSelected", update: "updateVisual"};
        n.registerAction(o, function (t, e) {
        ...
        i(1).registerPreprocessor(i(241)), i(243), i(238), i(239), i(240), i(290)
    }, function (t, e, i) {
        var n = i(1), o = i(0), r = i(49), a = i(10), s = ["#ddd"], l = n.extendComponentModel({
            type: "brush",
            ...
            setAreas: function (t) {
                __DEV__ && (o.assert(o.isArray(t)), o.each(t, function (t) {
                    o.assert(t.brushType, "Illegal areas")
        ...
        var o = i(0), r = ["rect", "polygon", "keep", "clear"];
        t.exports = function (t, e) {
            var i = t && t.brush;
        ...
        var h = i(1), c = i(49), d = i(0), f = i(7), p = i(242), g = i(48), m = i(58), v = ["inBrush", "outOfBrush"],
        ...
        i(88), i(34), i(35), i(250), i(251), i(246), i(247), i(85), i(84)
    }, function (t, e, i) {
        function n(t, e) {
            var i = [1 / 0, -(1 / 0)];
        ...
        var a = i(0), s = i(3), l = a.each, u = s.asc, h = function (t, e, i, n) {
        ...
        t.exports = i(34).extend({type: "dataZoom.inside", defaultOption: {disabled: !1, zoomLock: !1}})
    }, function (t, e, i) {
        function n(t) {
            var e = [0, 100];
        ...
        var o = i(35), r = i(0), a = i(60), s = i(252), l = r.bind, u = o.extend({
        ...
        t.exports = i(35).extend({type: "dataZoom.select"})
    }, function (t, e, i) {
        var n = i(34), o = n.extend({
        ...
        var o = i(0), r = i(2), a = i(48), s = i(35), l = r.Rect, u = i(3), h = u.linearMap, c = i(6), d = i(60),
        ...
        var h = i(0), c = i(42), d = i(48), f = h.curry, p = "\0_ec_dataZoom_roams", g = {
            register: function (t, e) {
        ...
        i(88), i(34), i(35), i(248), i(249), i(85), i(84)
    }, function (t, e, i) {
        function n(t, e) {
        ...
        function n(t, e, i, n) {
            var o = i.type;
            __DEV__ && l.assert(o, "graphic type MUST be set");
            var r = h[o.charAt(0).toUpperCase() + o.slice(1)];
            __DEV__ && l.assert(r, "graphic type can not be found");
            var a = new r(i);
        ...
        var s = i(1), l = i(0), u = i(5), h = i(2), c = (i(8), i(6));
                ...
                l.each(s, function (t, e) {
                    ...
                    if (__DEV__ && l.assert(l.isObject(n) || i, "Empty graphic option definition"), n) {
                        ...
                        if (f && "merge" !== f) "replace" === f ? o[e] = d : "remove" === f && i && (o[e] = null); else if (i) {
                            if (__DEV__) {
                                var p = n.type;
                                l.assert(!p || i.type === p, 'Please set $action: "replace" to change `type`')
                            }
            ...
            type: "graphic", init: function (t, e) {
                ...
                if (i) {
                    ...
                    l.each(i, function (t) {
                        ...
                        var d = r(t);
                        __DEV__ && u && l.assert(c === u.parent, "Changing parent is not supported."), e && "merge" !== e ? "replace" === e ? (o(u, a), n(i, c, d, a)) : "remove" === e && o(u, a) : u ? u.attr(d) : n(i, c, d, a), a[i] && (a[i].__ecGraphicWidth = t.width, a[i].__ecGraphicHeight = t.height)
                    })
                }
                ...
                for (var i = t.option.elements, n = this.group, o = this._elMap, r = i.length - 1; r >= 0; r--) {
                    var a = i[r], s = o[a.id];
                    if (s) {
                        var l = s.parent, u = l === n ? {width: e.getWidth(), height: e.getHeight()} : {
        ...
        i(258), i(260), i(259);
        var n = i(1);
        n.registerProcessor(i(261))
    }, function (t, e, i) {
        "use strict";
        var n = i(0), o = i(10), r = i(1).extendComponentModel({
            type: "legend",
            dependencies: ["series"],
            layoutMode: {type: "box", ignoreSize: !0},
            init: function (t, e, i) {
        ...
        var a = i(0), s = i(18), l = i(2), u = i(91), h = a.curry;
        t.exports = i(1).extendComponentView({
                ...
                if (s.removeAll(), t.get("show")) {
                    ...
                    a.each(t.getData(), function (a) {
                        ...
                        if (!f[u]) {
                            ...
                            __DEV__ && (f[u] || console.warn(u + " series not exists. Legend data should be same with series name or data name."))
                        }
        ...
        i(265), i(266), i(1).registerPreprocessor(function (t) {
            t.markArea = t.markArea || {}
        })
    }, function (t, e, i) {
        i(267), i(268), i(1).registerPreprocessor(function (t) {
            t.markLine = t.markLine || {}
        })
    }, function (t, e, i) {
        i(269), i(270), i(1).registerPreprocessor(function (t) {
            t.markPoint = t.markPoint || {}
        })
    }, function (t, e, i) {
        t.exports = i(61).extend({
            type: "markArea",
            defaultOption: {
                zlevel: 0,
                z: 1,
        ...
        var l = i(0), u = i(9), h = i(3), c = i(2), d = i(20), f = i(63), p = function (t, e, i, n) {
        ...
        var l = i(0), u = i(9), h = i(3), c = i(63), d = i(55), f = function (t, e, i, n) {
        ...
        var r = i(32), a = i(0), s = i(3), l = i(9), u = i(63);
        i(62).extend({
        ...
        "use strict";
        i(64), i(229), i(275), i(1).extendComponentView({type: "polar"})
    }, function (t, e, i) {
        i(329), i(330), i(274)
    }, function (t, e, i) {
        var n = i(33), o = i(0), r = i(2), a = ["axisLine", "axisLabel", "axisTick", "axisName"];
        t.exports = i(1).extendComponentView({
            type: "radar", render: function (t, e, i) {
                var n = this.group;
                ...
                if (a.length) {
                    ...
                    if ("circle" === s)for (var y = a[0].getTicksCoords(), x = i.cx, _ = i.cy, b = 0; b < y.length; b++) {
                        ...
                        for (var I = [], T = 0; T < a.length; T++)I.push(S[T][b]);
                        if (I[0] ? I.push(I[0].slice()) : __DEV__ && console.error("Can't draw value axis " + b), d) {
                            var w = e(m, p, b);
                            m[w].push(new r.Polyline({shape: {points: I}}))
                        }
                        if (f && M) {
                            var w = e(v, g, b - 1);
                            v[w].push(new r.Polygon({shape: {points: I.concat(M)}}))
                        }
                        M = I.slice().reverse()
                    }
        ...
        var n = i(1);
        n.registerPreprocessor(i(283)), i(285), i(284), i(278), i(279)
    }, function (t, e, i) {
        var n = i(281), o = i(0), r = i(5), a = n.extend({
        ...
        var s = i(0), l = i(2), u = i(6), h = i(282), c = i(280), d = i(18), f = i(15), p = i(7), g = i(19), m = i(3),
        ...
        var n = i(0), o = i(25), r = i(15), a = function (t, e, i, n) {
        ...
        var n = i(11), o = i(9), r = i(0), a = i(5), s = n.extend({
            type: "timeline",
            layoutMode: "box",
            defaultOption: {
                zlevel: 0,
            ...
            init: function (t, e, i) {
                this._data,
                    this._names, this.mergeDefaultAndTheme(t, i), this._initData()
            },
            mergeOption: function (t) {
        ...
        i(288), i(289), i(295), i(293), i(291), i(292), i(294)
    }, function (t, e, i) {
        var n = i(21), o = i(0), r = i(1).extendComponentModel({
            type: "toolbox",
            layoutMode: {type: "box", ignoreSize: !0},
            mergeDefaultAndTheme: function (t) {
        ...
        (function (e) {
            ...
            var o = i(21), r = i(0), a = i(2), s = i(10), l = i(45), u = i(91), h = i(23);
            t.exports = i(1).extendComponentView({
        ...
        var p = i(0), g = i(31), m = new Array(60).join("-"), v = "\t", y = new RegExp("[" + v + "]+", "g");
        d.defaultOption = {
            show: !0,
            readOnly: !1,
            ...
            this.remove(t, e)
        }, i(21).register("dataView", d), i(1).registerAction({
            type: "changeDataView",
        ...
        var s = i(0), l = i(57), u = i(58), h = i(87), c = s.each;
        i(253);
        ...
        }, i(21).register("dataZoom", n), i(1).registerPreprocessor(function (t) {
            function e(t, e) {
                if (e) {
                    var o = t + "Index", r = e[o];
        ...
        }), i(21).register("magicType", n), t.exports = n
    }, function (t, e, i) {
        "use strict";
        function n(t) {
            this.model = t
        ...
        }, i(21).register("restore", n), i(1).registerAction({
            type: "restore",
            event: "restore",
            update: "prepareAndUpdate"
        }, function (t, e) {
        ...
        }, i(21).register("saveAsImage", n), t.exports = n
    }, function (t, e, i) {
        i(298), i(299), i(1).registerAction({type: "showTip", event: "showTip", update: "none"}, function () {
        }), i(1).registerAction({type: "hideTip", event: "hideTip", update: "none"}, function () {
        })
    }, function (t, e, i) {
        function n(t) {
        ...
        var s = i(0), l = i(20), u = i(31), h = i(8), c = s.each, d = h.toCamelCase, f = i(14),
            p = ["", "-webkit-", "-moz-", "-o-"],
        ...
        var d = i(297), f = i(2), p = i(0), g = i(8), m = i(3), v = i(5), y = m.parsePercent, x = i(14), _ = i(10);
        i(1).extendComponentView({
            type: "tooltip", _axisPointers: {}, init: function (t, e) {
                ...
                } else"item" === n ? this._hide() : this._showAxisTooltip(i, o, t),
                "cross" === i.get("axisPointer.type") && r.dispatchAction({
                    type: "showTip",
                    from: this.uid,
                    x: t.offsetX,
                    y: t.offsetY
        ...
        var o = i(93), r = i(0), a = i(3), s = [20, 140], l = o.extend({
        ...
        var l = i(94), u = i(2), h = i(0), c = i(3), d = i(60), f = i(119), p = i(95), g = i(5), m = c.linearMap,
        ...
        var o = i(93), r = i(0), a = i(26), s = i(109), l = i(3).reformIntervals, u = o.extend({
            ...
            splitNumber: function () {
                ...
                r.each(t.pieces, function (t, i) {
                    ...
                    if (null != t.label && (n.text = t.label), t.hasOwnProperty("value")) {
                        ...
                        c[0] && s[1] === 1 / 0 && (l[0] = 0), c[1] && s[0] === -(1 / 0) && (l[1] = 0), __DEV__ && s[0] > s[1] && console.warn("Piece " + i + "is illegal: " + s + " lower bound should not greater then uppper bound."), s[0] === s[1] && l[0] && l[1] && (n.value = s[0])
                    }
        ...
        var n = i(94), o = i(0), r = i(2), a = i(18), s = i(6), l = i(95), u = n.extend({
        ...
        i(1).registerPreprocessor(i(96)), i(97), i(98), i(301), i(302), i(99)
    }, function (t, e, i) {
        i(1).registerPreprocessor(i(96)), i(97), i(98), i(303), i(304), i(99)
    }, function (t, e, i) {
        var n = i(0), o = i(25), r = i(311), a = function (t, e, i, n, r) {
        ...
        var r = i(317), a = i(0), s = i(7), l = i(100), u = [i(315), i(316), i(314)];
        n.prototype = {
        ...
        "use strict";
        var n = i(5), o = i(11), r = i(10), a = i(0), s = i(59), l = i(44), u = o.extend({
            type: "geo",
            coordinateSystem: null,
            layoutMode: "box",
            init: function (t) {
        ...
        var n = i(0), o = {Russia: [100, 60], "United States of America": [-99, 38]};
        t.exports = function (t) {
        ...
        var o = i(11), r = i(0), a = i(37), s = i(43), l = i(3), u = o.extend({
        ...
        r.merge(u.prototype, i(36)), s("parallel", u, n, h), t.exports = u
    }, function (t, e, i) {
        function n(t, e, i) {
            this._axesMap = {}, this._axesLayout = {}, this.dimensions = t.dimensions, this._rect, this._model = t, this._init(t, e, i)
        }

        var o = i(6), r = i(15), a = i(0), s = i(320), l = i(2), u = i(19), h = a.each, c = Math.PI;
        n.prototype = {
        ...
        var n = i(0), o = i(25), r = function (t, e, i, n, r) {
        ...
        var o = i(0), r = i(11), a = i(43), s = r.extend({type: "polarAxis", axis: null});
        o.merge(s.prototype, i(36)), o.merge(s.prototype, i(102));
        var l = {
        ...
        "use strict";
        var n = i(327), o = i(323), r = function (t) {
        ...
        "use strict";
        i(324), i(1).extendComponentModel({
            type: "polar",
        ...
        var o = i(0), r = i(328), a = i(46), s = i(3), l = i(15);
        ...
        }, i(16).register("radar", n), t.exports = n
    }, function (t, e, i) {
        function n(t, e) {
            return s.defaults({show: e}, t)
        }

        var o = i(101), r = o.valueAxis, a = i(10), s = i(0), l = i(36), u = i(1).extendComponentModel({
            type: "radar",
            optionUpdated: function () {
        ...
        var n = i(0), o = i(25), r = i(15), a = function (t, e, i, n, r) {
        ...
        var o = i(332);
        i(16).register("single", {create: n, dimensions: o.prototype.dimensions})
    }, function (t, e, i) {
        "use strict";
        function n(t, e) {
        ...
        var r = i(0), a = i(10), s = i(9), l = i(107), u = i(17), h = function (t, e) {
        ...
        var s = i(0), l = i(3), u = l.parsePercent;
        t.exports = a
    }, function (t, e, i) {
        var n = i(2), o = i(0), r = Math.PI;
        t.exports = function (t, e) {
            e = e || {}, o.defaults(e, {
                text: "loading",
                color: "#c23531",
        ...
        function u(t) {
            if (__DEV__ && !t._seriesIndices)throw new Error("Series has not been initialized yet.")
        }

        var h = i(0), c = i(5), d = i(10), f = h.each, p = h.filter, g = h.map, m = h.isArray, v = h.indexOf,
            y = h.isObject, x = i(11), _ = i(341), b = "\0_ec_inner", w = d.extend({
        ...
        var u = i(0), h = i(5), c = i(11), d = u.each, f = u.clone, p = u.map, g = u.merge, m = /^(min|max)?(.+)$/;
        n.prototype = {
        ...
        t.exports = {getAreaStyle: i(37)([["fill", "color"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["opacity"], ["shadowColor"]])}
    }, function (t, e) {
        t.exports = {
        ...
        var n = i(37)([["fill", "color"], ["stroke", "borderColor"], ["lineWidth", "borderWidth"], ["opacity"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["shadowColor"], ["textPosition"], ["textAlign"]]);
        t.exports = {
        ...
        var n = i(37)([["lineWidth", "width"], ["stroke", "color"], ["opacity"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["shadowColor"]]);
        t.exports = {
        ...
        var a = i(0), s = i(348), l = [["x", "left"], ["y", "top"], ["x2", "right"], ["y2", "bottom"]],
        ...
        var o = i(0), r = ["areaStyle", "lineStyle", "nodeStyle", "linkStyle", "chordStyle", "label", "labelLine"];
        t.exports = function (t) {
            if (t) {
        ...
        var o = i(0), r = i(47), a = i(3), s = i(46), l = r.prototype, u = s.prototype, h = a.getPrecisionSafe,
        ...
        var n = i(0), o = i(47), r = o.prototype, a = o.extend({
        ...
        var n = i(0), o = i(3), r = i(8), a = i(46), s = a.prototype, l = Math.ceil, u = Math.floor, h = 1e3,
        ...
        (function (e) {
            function i(t, e, i) {
                function o(e) {
                    var i = g, n = m;
                    return g = m = void 0, M = e, y = t.apply(n, i)
                }

                function r(t) {
                    return M = t, x = setTimeout(h, e), I ? o(t) : y
                }

                function l(t) {
                    var i = t - S, n = t - M, o = e - i;
                    return T ? b(o, v - n) : o
                }

                function u(t) {
                    var i = t - S, n = t - M;
                    return void 0 === S || i >= e || i < 0 || T && n >= v
                }

                function h() {
                    var t = w();
                    return u(t) ? c(t) : void(x = setTimeout(h, l(t)))
                }

                function c(t) {
                    return x = void 0, A && g ? o(t) : (g = m = void 0, y)
                }

                function d() {
                    void 0 !== x && clearTimeout(x), M = 0, g = S = m = x = void 0
                }

                function f() {
                    return void 0 === x ? y : c(w())
                }

                function p() {
                    var t = w(), i = u(t);
                    if (g = arguments, m = this, S = t, i) {
                        if (void 0 === x)return r(S);
                        if (T)return x = setTimeout(h, e), o(S)
                    }
                    return void 0 === x && (x = setTimeout(h, e)), y
                }

                var g, m, v, y, x, S, M = 0, I = !1, T = !1, A = !0;
                if ("function" != typeof t)throw new TypeError(s);
                return e = a(e) || 0, n(i) && (I = !!i.leading, T = "maxWait" in i, v = T ? _(a(i.maxWait) || 0, e) : v, A = "trailing" in i ? !!i.trailing : A), p.cancel = d, p.flush = f, p
            }
            ...
            function r(t) {
                return "symbol" == typeof t || o(t) && x.call(t) == u
            }
            ...
            function a(t) {
                ...
                t = t.replace(h, "");
                var i = d.test(t);
                return i || f.test(t) ? p(t.slice(2), i ? 2 : 8) : c.test(t) ? l : +t
            }

            var s = "Expected a function", l = NaN, u = "[object Symbol]", h = /^\s+|\s+$/g, c = /^[-+]0x[0-9a-f]+$/i,
                d = /^0b[01]+$/i, f = /^0o[0-7]+$/i, p = parseInt,
                g = "object" == typeof e && e && e.Object === Object && e,
                m = "object" == typeof self && self && self.Object === Object && self,
                v = g || m || Function("return this")(), y = Object.prototype, x = y.toString, _ = Math.max,
                b = Math.min, w = function () {
                    return v.Date.now()
                };
            t.exports = i
        }).call(e, i(70))
        ...
        t.exports = {
            render: function () {
                ...
                return i("div", {staticClass: "echarts"})
            }, staticRenderFns: []
        }
    }, function (t, e) {
        function i(t, e) {
            for (var i = 0; i < t.length; i++) {
                ...
                if (o) {
                    ...
                    for (; r < n.parts.length; r++)o.parts.push(s(n.parts[r], e))
                } else {
                    for (var a = [], r = 0; r < n.parts.length; r++)a.push(s(n.parts[r], e));
        ...
        function n(t) {
            for (var e = [], i = {}, n = 0; n < t.length; n++) {
                var o = t[n], r = o[0], a = o[1], s = o[2], l = o[3], u = {css: a, media: s, sourceMap: l};
                i[r] ? i[r].parts.push(u) : e.push(i[r] = {id: r, parts: [u]})
            }
            return e
        }
        ...
        function s(t, e) {
            ...
            if (e.singleton) {
                var s = g++;
                i = p || (p = a(e)), n = l.bind(null, i, s, !1), o = l.bind(null, i, s, !0)
            } else i = a(e), n = u.bind(null, i), o = function () {
                r(i)
            };
        ...
        function u(t, e) {
            var i = e.css, n = e.media, o = e.sourceMap;
        ...
        var r = i(0), a = i(50), s = i(121), l = i(120), u = function (t, e, i) {
            var s;
        ...
        var c = i(50), d = i(0), f = i(72), p = i(7), g = i(73), m = i(362), v = i(112), y = 5, x = new p(0, 0, 0, 0),
        ...
        b.prototype = {
            constructor: b, isSingleCanvas: function () {
                ...
                var u = i(74), h = new u({id: t, style: {x: 0, y: 0, image: a}});
        ...
        var o = i(0), r = i(14), a = i(51), s = i(73), l = function () {
        ...
        "use strict";
        var n = i(0), o = i(31).Dispatcher, r = i(112), a = i(111), s = function (t) {
        ...
        var n = i(116).normalizeRadian, o = 2 * Math.PI;
        t.exports = {
        ...
        var u = i(39).CMD, h = i(113), c = i(369), d = i(115), f = i(368), p = i(116).normalizeRadian, g = i(24),
            m = i(117), v = h.containStroke, y = 2 * Math.PI, x = 1e-4, _ = [-1, -1, -1], b = [-1, -1];
        t.exports = {
        ...
        var u = i(31), h = i(0), c = i(27), d = i(14), f = i(371), p = u.addEventListener, g = u.removeEventListener,
        ...
        "use strict";
        var n = i(0), o = i(53), r = function (t, e, i, n, r) {
        ...
        var n = i(4), o = n.min, r = n.max, a = n.scale, s = n.distance, l = n.add;
        t.exports = function (t, e, i, u) {
            var h, c, d, f, p = [], g = [], m = [], v = [];
            if (u) {
                d = [1 / 0, 1 / 0], f = [-(1 / 0), -(1 / 0)];
        ...
        var o = i(24), r = i(4), a = o.quadraticSubdivide, s = o.cubicSubdivide, l = o.quadraticAt, u = o.cubicAt,
        ...
        "use strict";
        var n = i(111), o = i(0), r = o.isString, a = o.isFunction, s = o.isObject, l = i(72), u = function () {
            this.animators = []
        };
        u.prototype = {
        ...
        var a = i(12), s = i(39), l = i(391), u = i(19),
        ...
        var o = i(39).CMD, r = i(4), a = r.applyTransform, s = [[], [], []], l = Math.sqrt, u = Math.atan2;
        t.exports = n
    }, function (t, e, i) {
        function n(t) {
            return parseInt(t, 10)
            ...
            constructor: o, getViewportRoot: function () {
                ...
                for (var e = this._vmlRoot, i = 0; i < t.length; i++) {
                    ...
                    n.invisible || n.ignore ? (n.__alreadyNotVisible || n.onRemove(e), n.__alreadyNotVisible = !0) : (n.__alreadyNotVisible && n.onAdd(e),
                        n.__alreadyNotVisible = !1, n.__dirty && (n.beforeBrush && n.beforeBrush(), (n.brushVML || n.brush).call(n, e), n.afterBrush && n.afterBrush())), n.__dirty = !1
                }
        ...
        if (!i(14).canvasSupported) {
            var n = i(4), o = i(7), r = i(39).CMD, a = i(20), s = i(23), l = i(124), u = i(52), h = i(74), c = i(122),
                d = i(12), f = i(53), p = i(126), g = Math.round, m = Math.sqrt, v = Math.abs, y = Math.cos,
                ...
                M = 21600, I = M / 2, T = 1e5, A = 1e3, L = function (t) {
                    ...
                    if (null != n)if (n instanceof f) {
                        ...
                        if (T >= 2) {
                            var k = A[0][0], E = A[1][0], O = A[0][1] * e.opacity, V = A[1][1] * e.opacity;
                            t.type = o, t.method = "none", t.focus = "100%", t.angle = r, t.color = k, t.color2 = E, t.colors = L.join(","), t.opacity = V, t.opacity2 = O
                        }
                        "radial" === o && (t.focusposition = a.join(","))
                    } else z(t, n, e.opacity)
                }, N = function (t, e) {
                    null != e.lineDash && (t.dashstyle = e.lineDash.join(" ")), null == e.stroke || e.stroke instanceof f || z(t, e.stroke, e.opacity)
                }, B = function (t, e, i, n) {
                    ...
                    for (a = 0; a < t.length;) {
                        switch (o = t[a++], n = "", i = 0, o) {
                            ...
                            case h:
                                ...
                                break;
                            case d:
                                var C = 0, D = 0, P = 1, k = 1, E = 0;
                                e && (C = e[4], D = e[5], P = m(e[0] * e[0] + e[1] * e[1]), k = m(e[2] * e[2] + e[3] * e[3]), E = Math.atan2(-e[1] / k, e[0] / P));
                                var O = t[a++], z = t[a++], R = t[a++], V = t[a++], N = t[a++] + E, B = t[a++] + N + E;
                                a++;
                                var F = t[a++], H = O + y(N) * R, W = z + x(N) * V, S = O + y(B) * R, T = z + x(B) * V,
                                    Z = F ? " wa " : " at ";
                                Math.abs(H - S) < 1e-10 && (Math.abs(B - N) > .01 ? F && (H += 270 / M) : Math.abs(W - z) < 1e-10 ? F && H < O || !F && H > O ? T -= 270 / M : T += 270 / M : F && W < z || !F && W > z ? S += 270 / M : S -= 270 / M), p.push(Z, g(((O - R) * P + C) * M - I), w, g(((z - V) * k + D) * M - I), w, g(((O + R) * P + C) * M - I), w, g(((z + V) * k + D) * M - I), w, g((H * P + C) * M - I), w, g((W * k + D) * M - I), w, g((S * P + C) * M - I), w, g((T * k + D) * M - I)), s = S, l = T;
                                break;
                            case r.R:
                                var q = G[0], j = G[1];
            ...
            d.prototype.brushVML = function (t) {
                ...
                var l = this.path;
                this.__dirtyPath && (l.beginPath(), this.buildPath(l, this.shape), l.toStatic(), this.__dirtyPath = !1), i.path = F(l.data, this.transform), i.style.zIndex = E(this.zlevel, this.z, this.z2), P(t, i), null != e.text ? this.drawRectText(t, this.getBoundingRect()) : this.removeRectText(t)
            ...
            h.prototype.brushVML = function (t) {
                ...
                if (o) {
                    ...
                    if (this.transform && (T = this.transform, D = m(T[0] * T[0] + T[1] * T[1]), k = m(T[2] * T[2] + T[3] * T[3]), C = T[1] || T[2]), C) {
                        var O = [u, h], z = [u + c, h], R = [u, h + d], V = [u + c, h + d];
                        b(O, O, T), b(z, z, T), b(R, R, T), b(V, V, T);
                        var N = _(O[0], z[0], R[0], V[0]), B = _(O[1], z[1], R[1], V[1]), G = [];
                        G.push("M11=", T[0] / D, w, "M12=", T[2] / k, w, "M21=", T[1] / D, w, "M22=", T[3] / k, w, "Dx=", g(u * D + T[4]), w, "Dy=", g(h * k + T[5])), A.padding = "0 " + g(N) + "px " + g(B) + "px 0", A.filter = S + ".Matrix(" + G.join("") + ", SizingMethod=clip)"
                    ...
                    var X = "", Y = n.opacity;
                    Y < 1 && (X += ".Alpha(opacity=" + g(100 * Y) + ") "), X += S + ".AlphaImageLoader(src=" + o + ", SizingMethod=scale)", Z.filter = X, I.style.zIndex = E(this.zlevel, this.z, this.z2), P(t, I), null != n.text && this.drawRectText(t, this.getBoundingRect())
                }
            ...
            for (var $ = new o, Q = function (t, e, i, n) {
                ...
                if (null != r && (r += ""), r) {
                    ...
                    if (m && !n && ($.copy(e), $.applyTransform(m), e = $), n) a = e.x, l = e.y; else {
                        ...
                        if (v instanceof Array) a = e.x + O(v[0], e.width), l = e.y + O(v[1], e.height), u = u || "left", d = d || "top"; else {
                    ...
                    B(A, "fill", {
                        ...
                        opacity: o.opacity,
                        lineDash: o.lineDash
                    }, this), A.style.zIndex = E(this.zlevel, this.z, this.z2), P(t, A)
                }
            }, J = function (t) {
                ...
                it.drawRectText = Q, it.removeRectText = J, it.appendRectText = K
            }
        ...
        i(393), i(127).registerPainter("vml", i(392))
    }, function (t, e, i) {
        "use strict";
        function n(t) {
            return t && t.__esModule ? t : {"default": t}
